...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8008639864:AAGlkU8XivAYRg34OsOeE_VUOBqGRmHL7Ak")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002199871284"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002199871284"))
...
ADMINS.append(5469101870)

LOG_FILE_NAME = "obitozero.txt"
